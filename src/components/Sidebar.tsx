    ...
    <aside className="w-64 h-screen bg-surface border-r border-border flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-8 border-b border-border">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center text-background font-black text-xl shadow-lg shadow-accent/20">
            JP
          </div>
      ...
      <div className="p-4 border-t border-border bg-background/50">
        <div className="p-4 rounded-2xl border border-border bg-surface flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-border/50">
             <button className="flex-1 p-2 rounded-lg hover:bg-white/5 border border-transparent hover:border-border transition-all flex items-center justify-center text-muted hover:text-foreground">
                <Settings size={14} />
             </button>
             <button 
               onClick={logout}
